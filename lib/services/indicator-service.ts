...
// Re-export IndicatorConfig and AVAILABLE_INDICATORS from static metadata
export type { IndicatorConfig } from "@/lib/data/static-metadata"
export { AVAILABLE_INDICATORS } from "@/lib/data/static-metadata"
