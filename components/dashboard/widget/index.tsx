...
export default function Widget() {
  ...
  useEffect(() => {
    ...
    // In production, fetch actual location and weather from an API
    // For now, use browser timezone to infer location
    const locationName = tz.split("/")[1]?.replace("_", " ") || "Unknown"
